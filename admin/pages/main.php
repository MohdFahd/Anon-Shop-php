        ...
        <div class="container-fluid py-4">
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <?php
                                $date = date('Y-m-j');
                                $todayMoney = qselectf("SELECT sum(total) as total FROM orders WHERE created_at LIKE '%$date%';");
                                ?>
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Today's Money</p>
                                        <h5 class="font-weight-bolder mb-0">
                                            $<?=count($todayMoney) == 0 ? $todayMoney['total'] : '0'?>
            ...
            <div class="row ">
                <div class="col-xl-12 col-lg-12 col-md-12 col-12 mb-6">
                    <div class="card h-100 card-lg p-3 my-3">
                        <div class="card-body p-0">
                            <!-- table -->
                            <h3 class="mb-0 fs-5 my-3">Recent Order</h3>
                            <?php $orders =  query("SELECT * FROM orders ORDER BY created_at DESC ");
                            ?>
                            <div class="table-responsive">
                                <table id="datatable_orders"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-<?=$color?> text-warning-primary "><?=$text?></span>
                                            </td>
                                            <td class="text-muted text-center align-middle border-top-0">
                                                <a href="./order_tracking.php?id=<?= $order['id']; ?>"
                                                    class="text-inherit" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" data-bs-title="View">
                                                    <i class="fa-regular fa-pen-to-square" style="color: #629e61;"></i>
                                                </a>
                                            </td>
                                        </tr>
                                        <?php
                                ...
                                <script>
                                let datatable_orders = new DataTable('#datatable_orders');
                                $('#datatable_orders_filter input').attr('placeholder', 'Search for...');
                                </script>
                            </div>
                        </div>
                    </div>
